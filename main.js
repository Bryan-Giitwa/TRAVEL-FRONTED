//Javascript code to handle menu items and menu icon
...
ScrollReveal().reveal(".content_header .section_subheader", {
  ...scrollRevealOption,
  delay: 500,
});

ScrollReveal().reveal(".content_header h1", {
  ...scrollRevealOption,
  delay: 1000,
});

ScrollReveal().reveal(".content_header p", {
  ...scrollRevealOption,
  delay: 1500,
});
